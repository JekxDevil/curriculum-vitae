...
\address{
    \includegraphics[width=\iconsize, trim={0cm 1.5cm 1.5cm 0cm}, clip]{phone-icon.png}
    +39 3278557818 
    \\ 
    \includegraphics[width=\iconsize, trim={0cm 1.5cm 1.5cm 0cm}, clip]{maps-icon.png}
    Lugano, Switzerland
} 
\address{
...
\begin{rSection}{Education}
    ...
    {\bf \underline{Bachelor of Science in Informatics}},
    \href{https://www.usi.ch/en}{USI}, Switzerland
    \hfill {2021 - Expected 2024}

    \textbf{Scholarship}: has a nominal value of 8,000 CHF, equal to the cost
    of the annual tuition fee at USI.
    The scholarship is renewable annually for an additional two years,
    if recipients obtain all the credits required by the program
    while maintaining an average of at least 8/10.\\
    GPA 9.24/10. Degree in English language.
    ...
    {\bf \underline{Diploma in Informatics}},
