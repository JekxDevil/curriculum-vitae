...
\begin{rSection}{Languages}
    \vspace{0.2cm}
    % \item English  Fluent B2 Certificate     
    % \item Italian  Native                    
    % \item Spanish  Native                    
    % \item French   A3 Certificate            
...
\begin{rSection}{PROJECTS}
    ...
    % Skills: Docker, Java Spring Boot, Vue, GitOps, junit, nginx, SonarQube, CI/CD, fullstack, Scrum, mongodb, SSE
    ...
    % skills: Vue, vuetify, node.js, express.js, mongodb, web sockets, webRTC, peer.js, material design,
\end{rSection}
%--- LEADERSHIP -------------------------------------------------------------------------
