...
\begin{rSection}{Skills}
    ...
    Vuejs, Vue, vuetify, nodejs, node.js, expressjs, express.js, web sockets, webRTC, material design, % frontend
...
\begin{rSection}{Leadership \& Achievements}
    ...
    \item \href{https://cyberchallenge.it/}{CyberChallenge} 2019 \textbf{youngest} student
        in \textit{Marche} region, organised in Italy. % Cybersecurity National Lab.
