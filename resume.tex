...
\mobile{(+39) 3278-5578-18}
\email{jeferson.morales.mariciano@gmail.com}
\homepage{jefersonmm.com}
\github{jekxdevil}
\linkedin{jefersonmm}
% \gitlab{gitlab-id}
...
% \skype{skype-id}
% \reddit{reddit-id}
\extrainfo{EU, Permit B, Driving License}
...
\makecvfooter
  {\today}
  % {Jeferson J. Morales Mariciano~~~·~~~Résumé}
  {}
...
\vspace{-0.4cm}
% \input{resume/organizations.tex} usi repr in honors
